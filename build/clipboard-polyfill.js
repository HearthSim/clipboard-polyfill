...
var PromiseOrPolyfill = (typeof Promise === "undefined") ? es6_promise_1.Promise : Promise;
...
var ClipboardPolyfill = /** @class */ (function () {
    ...
    ClipboardPolyfill.write = function (data) {
        ...
        return (new PromiseOrPolyfill(function (resolve, reject) {
            // Internet Explorer
            if (seemToBeInIE()) {
                if (writeIE(data)) {
                    resolve();
...
var warn = function (message, details) {
